...
```text
binder_status: OPEN
real_wmh2017_run_evidence: NOT_GENERATED
...
| Dataset manifest | `reports/dataset_manifest.csv` | not generated | Sev1 for training/eval claim |
| Label audit | `reports/label_value_audit.csv` | not generated | Sev1 for training/eval claim |
| Split manifest | `data/splits/wmh2017_train_val_seed42.csv` | not generated | Sev1 for training/eval claim |
...
| Run evidence | `artifacts/runs/<run_id>/run_evidence.json` | not generated | Sev1 |
